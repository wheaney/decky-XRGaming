...
import commonDisplayResolutionGif from "../assets/tutorials/common/display-resolution.gif";
import commonGamePropertiesGif from "../assets/tutorials/common/game-properties-resolution.gif";
import vdSidebarPerformanceGif from "../assets/tutorials/virtual_display/sidebar-performance.gif";
import sbsScalingStretch from "../assets/tutorials/sbs/scaling-mode-stretch.gif";
    ...
    return <Fragment>
        <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
            <PanelSection title={"Limitations"}>
                <p>Virtual display mode will only work under certain conditions:</p>
                <ul>
        ...
        <PanelSection title={"Optimizing Performance"}>
            ...
            <ol>
                <li style={listItem}>
                    ...
                    <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
                        <img src={commonDisplayResolutionGif} alt="Setting the Display Resolution" style={gifStyle}/>
                    </Focusable>
                </li>
                <li style={listItem}>
                    ...
                    <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
                        <img src={commonGamePropertiesGif} alt="Setting the resolution in game properties" style={gifStyle}/>
                    </Focusable>
                </li>
                <li style={listItem}>
                    <p>In <span style={navigationDetail}>the Deck's ... Performance menu</span>, flip on <span
                        ...
                        Tearing</span>.</p>
                    <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
                        <img src={vdSidebarPerformanceGif} alt="Modifying performance settings" style={gifStyle}/>
                    </Focusable>
                </li>
                <li style={listItem}>
                    <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
...
function SBSTutorial() {
    return <Fragment>
        <PanelSection title={'Usage'}>
            <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
                <p>
                    <b>NOTE: This mode DOES NOT create 3D depth in games that don't already support it natively.</b>
                </p>
                <p>
                    Enabling this toggle will switch your glasses to side-by-side mode, which will make it difficult to
                    navigate non-game content, such as Steam. For the best experience, wait until after you've launched
                    a game to enable SBS mode, and disable it before exiting the game.
                </p>
                <p>
                    ...
                    render stereoscopic 3D content in the virtual display for games that do support it natively, or you
            ...
            <ol>
                ...
                <li style={listItem}>
                    <p>In <span style={navigationDetail}>the Deck's ... Performance menu</span>, move the <span
                        ...
                        Stretch</span>.</p>
                    <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
                        <img src={sbsScalingStretch} alt="Setting Scaling Mode to Stretch" style={gifStyle}/>
                    </Focusable>
                </li>
            </ol>
        </PanelSection>
        <PanelSection title={'Controls'}>
            <Focusable focusWithinClassName="gpfocuswithin" onActivate={() => {}} noFocusRing={true}>
                ...
                <p>
                    ...
                    <ul>
                        <li><span style={actionLabel}>Display distance</span> uses 3D depth perception to make the
                            screen appear farther or closer. Since items that are closer also appear larger, you'll
                        ...
                        <li><span style={actionLabel}>Content is stretched</span> indicates that your game is being
                        ...
                        <li><span style={actionLabel}>Content is 3D</span> indicates that the game is rendering as
                            stereoscopic, side-by-side 3D, either natively or using a tool that adds 3D depth.</li>
                    </ul>
                </p>
            </Focusable>
        </PanelSection>
